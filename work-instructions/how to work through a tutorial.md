...
NOTE: both *old-tutorial-name* and *new-tutorial-name* should contain two path elements: `query_params_str_validations/tutorial002_an_py310.py` `query_params_str_validations` and `tutorial002_an_py310.py`
